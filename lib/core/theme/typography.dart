...
class AppTypography {
  static TextTheme textTheme({Brightness brightness = Brightness.light}) {
    ...
    return tt.copyWith(
      displayLarge: tt.displayLarge?.copyWith(fontWeight: FontWeight.w900, letterSpacing: -0.5),
      displayMedium: tt.displayMedium?.copyWith(fontWeight: FontWeight.w800, letterSpacing: -0.25),

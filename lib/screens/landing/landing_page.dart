...
class _LandingPageState extends ConsumerState<LandingPage> {
                      ...
                      if (items.isEmpty)
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (_, int index) {
                            ...
                            final title = (m['title'] ?? 'Introduktion').toString();
                            return ListTile(
                              ...
                              onTap: () {
                                ...
                                if (!mounted) return;
                                context.go('/course-intro?id=$id&title=${Uri.encodeComponent(title)}');
                              },
                            );
                          },
                        ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Positioned.fill(child: const BackgroundLayer()),
          SafeArea(
            child: Stack(
              children: [
                Positioned(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const Wrap(
                                  ...
                                  alignment: WrapAlignment.center,
                                  children: [
                                    _StatChip(icon: Icons.emoji_events, a: 'Över 1000+', b: 'nöjda elever'),
                                    _StatChip(icon: Icons.verified, a: 'Certifierade', b: 'lärare'),
                                    _StatChip(icon: Icons.verified_user, a: '30 dagars', b: 'garanti'),
                                  ],
                                ),
                              ],
                            ),
                                            ...
                                            for (final m in items)
                                              SizedBox(
                                                ...
                                                child: _CourseTile(
                                                  ...
                                                  imageUrl: (m['cover_url'] ?? '') as String?,
                                                  isIntro: m['is_free_intro'] == true,
                                                  onTap: () => context.go('/course-intro?id=${m['id']}&title=${Uri.encodeComponent(m['title'] ?? '')}'),
                                                ),
                                              ),
                                          ],
                                        );
                                    ...
                                    data: (state) {
                                      ...
                                      return ListView.separated(
                                        ...
                                        itemBuilder: (context, index) {
                                          final t = items[index];
                                          return _TeacherPill(
                                            name: (t['display_name'] ?? 'Lärare') as String,
                                            avatarUrl: (t['photo_url'] ?? '') as String?,
                                            bio: (t['bio'] ?? '') as String?,
                                          );
                                        },
                                      );
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  const Expanded(
                                    child: Text('Redo att börja? Skapa konto eller utforska kurser.'),
                                  ),
                                  FilledButton(
...
class _LandingMessage extends StatelessWidget {
  ...
  final String? hint;
  final bool center;
  const _LandingMessage({required this.message, this.hint, this.center = false});

  @override
  Widget build(BuildContext context) {
    final CrossAxisAlignment alignment = center ? CrossAxisAlignment.center : CrossAxisAlignment.start;
    ...
    return Row(
      ...
      children: [
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(a, style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.w700)),
            Text(b, style: Theme.of(context).textTheme.bodySmall?.copyWith(color: Colors.black54)),
          ],
        ),
      ],
    );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (hasBio) ...[
                      ...
                      const SizedBox(height: 6),
                      const Text('Bio saknas', style: TextStyle(color: Colors.black54)),
                      TextButton(
...
class _ServiceTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final String priceText = priceCents == null ? '' : '${(priceCents! / 100).toStringAsFixed(0)} kr';
    return Card(
      elevation: 0,
      margin: EdgeInsets.zero,
      child: Padding(
  ...
  Widget build(BuildContext context) {
    final items = [
      ...
      (
        ...
        title: 'Följ upp',
        text: 'Spara favoriter, fortsätt där du slutade och väx tillsammans med communityn.',
      ),
    ];
